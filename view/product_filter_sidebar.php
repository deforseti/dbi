				...
				<div class="test">
                    <form class="filter_form" method="get" action="./FilterCategory">
                        ...
                        <div class="col-lg-12 filters right">
                            ...
                            <span>(<?= (int) $metadata['count_filters']['sales'] ?? 0 ?>)</span>
                        </div>
                        <div class="col-lg-12 filters">
                            <hr>
                        </div>
                        ...
                        <div class="col-lg-12 filters right">
                            ...
                            <?php foreach ($metadata['filters']['lists']['brands'] as $brand): ?>
                                <li>
                                    ...
                                    <input type="checkbox" <?= $checked ?> name="brand_<?= $brand['type_id']?>" id="brand_<?= $brand['type_id']?>" data-id="<?= $brand['type_id']?>" data-filter="brand" class="checkbox-filter__link">
                                    <label for="brand_<?= $brand['type_id']?>">
                                        <?= $brand["name_".$LANG]?>
                                    </label>
                                    <span><?= (int) $metadata['count_filters']['brands'][$brand['type_id']] ?? 0?></span>
                                </li>
                            <?php endforeach;?>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-12 filters right">
                            ...
                            <div class="col-lg-12">
                                <div class="row">
                                    <input type="number" class="col-lg-4" name="filter_price_min" maxlength="10" min="0" value="<?= $_GET['price_min'] ?>">
                                    <span class="col-lg-1">-</span>
                                    <input type="number" class="col-lg-4" name="filter_price_max" maxlength="10" value="<?= $_GET['price_max'] ?>">
                                    <input type="submit" class="btn btn-primary btn-sm col-lg-2" style="float: right" value="Ок" onclick="setFiltersCategory('price')">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 filters">
                            ...
                            <ul>
                                <?php foreach ($metadata['filters']['lists']['materials'] as $material): ?>
                                    <li>
                                        ...
                                        <input type="checkbox"<?= $checked ?> name="material_<?= $material['type_id']?>" id="material_<?= $material['type_id']?>" data-id="<?= $material['type_id']?>" data-filter="material" class="checkbox-filter__link">
