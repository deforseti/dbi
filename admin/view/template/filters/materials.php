...
<div class="container wrapp_content">
    <table class="table">
        ...
        <tbody>
            ...
            <?php foreach ($object['materials'] as $material) :?>
            <form method="post">
                <tr>
                    <input hidden name="id" value="<?= $material['id']?>">
                    <th><input class="form-control" type="text" name="name_ru" required value="<?= $material['name_ru'] ?>"></th>
                    <td><input class="form-control" type="text" name="name_uk" required value="<?= $material['name_uk'] ?>"></td>
                    <td><input class="form-control" type="text" name="name_en" required value="<?= $material['name_en'] ?>"></td>
                    <div class="row">
                        <td>
                            <div class="row">
